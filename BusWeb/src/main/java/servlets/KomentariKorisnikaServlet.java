...
public class KomentariKorisnikaServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try{
			...
			List<Komentar> komentars = new PrevoznikManager().sviKomentariZaPrevoznika(idPrevoznika);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try{
			...
			Komentar komentar = new KomentarManager().sacuvajKomentar(datumKom, ocena, tekstKomentara, prevoznik, putnik);
